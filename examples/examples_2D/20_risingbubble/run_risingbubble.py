...
# SETUP SIMULATION
input_reader = InputReader("risingbubble.json", "numerical_setup.json")
...
ax[2].imshow(np.transpose(plot_dict["velocityX"][-1,:,:,0]), origin="lower")
ax[3].imshow(np.transpose(plot_dict["velocityY"][-1,:,:,0]), origin="lower")
plt.show()