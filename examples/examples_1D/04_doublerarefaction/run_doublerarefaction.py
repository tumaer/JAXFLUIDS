...
# SETUP SIMULATION
input_reader = InputReader("doublerarefaction.json", "numerical_setup.json")
...
quantities = ["density", "velocityX", "pressure", "temperature"]
...
ax[2].plot(cell_centers[0], data_dict["temperature"][-1 ,:,0,0])
plt.show()