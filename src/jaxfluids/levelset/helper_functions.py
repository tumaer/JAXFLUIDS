...
def move_source_to_target_ii(source_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray, axis: int) -> jnp.DeviceArray:
...
def move_source_to_target_ij(source_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray, axis_i: int, axis_j: int) -> jnp.DeviceArray:
...
def move_source_to_target_ijk(source_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray) -> jnp.DeviceArray:
...
def move_target_to_source_ii(target_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray, axis: int) -> jnp.DeviceArray:
...
def move_target_to_source_ij(target_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray, axis_i: int, axis_j: int) -> jnp.DeviceArray:
...
def move_target_to_source_ijk(target_array: jnp.DeviceArray, normal_sign: jnp.DeviceArray) -> jnp.DeviceArray:
