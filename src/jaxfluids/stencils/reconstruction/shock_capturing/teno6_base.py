...
class TENO6Base(SpatialReconstruction):
    """TENO6Base implements basic functionality
    for TENO6Base-type stencils.
    ...
    def __init__(self, nh: int, inactive_axes: List, offset: int = 0, **kwargs) -> None:
        super(TENO6Base, self).__init__(nh, inactive_axes, offset)
    ...
    def smoothness(self, u_imm: Array, u_im: Array, 
        ...
        beta_3 = 1.0 / 240.0 * (
              u_i   * (2107  * u_i   - 9402  * u_ip  + 7042 * u_ipp - 1854 * u_ippp) \
            + u_ip  * (11003 * u_ip  - 17246 * u_ipp + 4642 * u_ippp) \
            + u_ipp * (7043  * u_ipp - 3882  * u_ippp) \
            + 547 * u_ippp * u_ippp)
        beta_6 = 1.0 / 10080 / 12 * (
            271779 * u_imm * u_imm + \
        ...
        return beta_0, beta_1, beta_2, beta_3, beta_6
    ...
    def polynomials(self, u_imm: Array, u_im: Array, 
        ...
        p_3 = self._cr[3][0] * u_i   + self._cr[3][1] * u_ip + self._cr[3][2] * u_ipp + self._cr[3][3] * u_ippp
