...
class DerivativeSecondOrderDownwindAdapCenter(SpatialDerivative):
    ...
    def __init__(
        ...
        super(DerivativeSecondOrderDownwindAdapCenter, self).__init__(nh=nh,
        ...
        for i, axis in enumerate(["x", "y", "z"]):
            ...
            if is_mesh_stretching[i]:
                ...
                delta_x2 = cell_sizes_i[self.s_mesh[i][2]] # dx_{i+2}
                
                d0 = 0.0
                d1 = 0.5 * (delta_x0 + delta_x1)
                d2 = 0.5 * delta_x0 + delta_x1 + 0.5 * delta_x2
